...
### Setup Steps:
1. Created S3 bucket: `jeevith-itcs6190-assignment3` in `us-east-1` region
...
- **Data Source:** `s3://jeevith-itcs6190-assignment3/processed/`
...
- **Database:** `orders_db`
- **Table:** `processed`
- **Query Result Location:** `s3://jeevith-itcs6190-assignment3/enriched/`
...
- **S3 Output Location:** s3://jeevith-itcs6190-assignment3/enriched/
...
└── screenshots/                  # Assignment screenshots
    ...
    ├── 04-s3-trigger.png
    ├── 05-processed-csv.png
    ├── 06-crawler-cloudwatch.png
    ├── 07-athena-results.png
    └── 08-web-dashboard.png
```
